# ----------------------------------------------------------------------------
# Code for a Multinomial Logit Model with Random Coefficients and constraints
# 
...
choicedata <- read.table("mnl_simulated.dat", sep = "\t", header = TRUE)
...
modelname <- "MNL_constrained" # used for output
